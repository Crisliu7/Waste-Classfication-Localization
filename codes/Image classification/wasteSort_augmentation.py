...
if __name__ == '__main__':
    ...
    exp_lr_scheduler = lr_scheduler.MultiStepLR(optimizer_ft, [40, 70], gamma=0.5, last_epoch=-1)

    '''
    Result recording
    '''
    result_dir = 'result/222222'
    # folder
    if not os.path.exists(result_dir):
        os.makedirs(result_dir)
    # image sample display

    model_ft = train_model(model_ft, optimizer_ft, exp_lr_scheduler, num_epochs=90)
